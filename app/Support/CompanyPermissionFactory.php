...
class CompanyPermissionFactory
{
    ...
    protected static function getMap(): array
    {
        $base = [
            ...
            'view_sms' => ['name' => 'view_sms', 'slug' => 'view_sms', 'display_name' => 'View SMS', 'description' => 'View SMS conversations in phone system', 'category' => 'phone'],
            'send_sms' => ['name' => 'send_sms', 'slug' => 'send_sms', 'display_name' => 'Send SMS', 'description' => 'Send SMS messages from phone system', 'category' => 'phone'],

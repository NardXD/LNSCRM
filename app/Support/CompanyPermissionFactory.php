...
class CompanyPermissionFactory
{
    ...
    protected static function getMap(): array
    {
        $base = [
            ...
            'send_broadcast_sms' => ['name' => 'send_broadcast_sms', 'slug' => 'send_broadcast_sms', 'display_name' => 'Send SMS Broadcasts', 'description' => 'Create and send bulk SMS broadcasts via Twilio', 'category' => 'main'],
            'send_broadcast_email' => ['name' => 'send_broadcast_email', 'slug' => 'send_broadcast_email', 'display_name' => 'Send Email Broadcasts', 'description' => 'Create and send bulk email broadcasts via Microsoft 365', 'category' => 'main'],
            'manage_twilio_numbers' => ['name' => 'manage_twilio_numbers', 'slug' => 'manage_twilio_numbers', 'display_name' => 'Manage Twilio Numbers', 'description' => 'Purchase and assign Twilio phone numbers', 'category' => 'main'],
            ...
            'discussions' => ['name' => 'view_discussions', 'slug' => 'view_discussions', 'display_name' => 'Discussions', 'description' => 'Access to internal teammate discussions', 'category' => 'main'],
            'create_discussion_tags' => ['name' => 'create_discussion_tags', 'slug' => 'create_discussion_tags', 'display_name' => 'Add Discussion Tags', 'description' => 'Create tags used on discussions', 'category' => 'main'],
            'create_discussion_rules' => ['name' => 'create_discussion_rules', 'slug' => 'create_discussion_rules', 'display_name' => 'Add Discussion Rules', 'description' => 'Create, edit, and delete discussion automation rules', 'category' => 'main'],
            ...
            'view_facebook_reports' => ['name' => 'view_facebook_reports', 'slug' => 'view_facebook_reports', 'display_name' => 'Facebook Reports', 'description' => 'Access to the Facebook/Instagram reports page and its charts', 'category' => 'main'],
            ...
            'create_message_templates' => ['name' => 'create_message_templates', 'slug' => 'create_message_templates', 'display_name' => 'Add Message Templates', 'description' => 'Create, edit, and delete SMS, Facebook, WhatsApp, and Viber reply templates', 'category' => 'main'],
            'create_lead_rules' => ['name' => 'create_lead_rules', 'slug' => 'create_lead_rules', 'display_name' => 'Add Lead Rules', 'description' => 'Create, edit, and delete lead automation rules', 'category' => 'main'],
            ...
            'view_hiring_queue' => ['name' => 'view_hiring_queue', 'slug' => 'view_hiring_queue', 'display_name' => 'Hiring Queue', 'description' => 'Access to the hiring queue module', 'category' => 'main'],
            'leads' => ['name' => 'view_leads', 'slug' => 'view_leads', 'display_name' => 'Leads', 'description' => 'Access to the leads module', 'category' => 'main'],
            'view_lead_reports' => ['name' => 'view_lead_reports', 'slug' => 'view_lead_reports', 'display_name' => 'Lead Reports', 'description' => 'Access to the lead reports page and its charts/exports', 'category' => 'main'],
            ...
            'quotation-builder-microsoft-365-mail' => ['name' => 'view_quotation_builder_microsoft_365_mail', 'slug' => 'view_quotation_builder_microsoft_365_mail', 'display_name' => 'Microsoft 365 Mail', 'description' => 'Access to configure Microsoft 365 mail for quotation builder', 'category' => 'quotation-builder'],
            'quotation-builder-email-template' => ['name' => 'view_quotation_builder_email_template', 'slug' => 'view_quotation_builder_email_template', 'display_name' => 'Email Template', 'description' => 'Access to configure the quotation builder email template', 'category' => 'quotation-builder'],
            ...
            'contracts-microsoft-365-mail' => ['name' => 'view_contracts_microsoft_365_mail', 'slug' => 'view_contracts_microsoft_365_mail', 'display_name' => 'Microsoft 365 Mail', 'description' => 'Access to configure Microsoft 365 mail for contracts', 'category' => 'contracts'],
            'contracts-email-template' => ['name' => 'view_contracts_email_template', 'slug' => 'view_contracts_email_template', 'display_name' => 'Email Template', 'description' => 'Access to configure the contracts email template', 'category' => 'contracts'],

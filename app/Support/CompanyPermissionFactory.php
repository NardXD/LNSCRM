...
class CompanyPermissionFactory
{
    ...
    protected static function getMap(): array
    {
        $base = [
            ...
            'create_message_templates' => ['name' => 'create_message_templates', 'slug' => 'create_message_templates', 'display_name' => 'Add Message Templates', 'description' => 'Create, edit, and delete SMS and Facebook reply templates', 'category' => 'main'],

    ...
    <p class="initial-line">Initial <span @if(! ($data['signature_base64'] ?? null)) class="signature-line" @endif style="width:100px;">@if($data['signature_base64'] ?? null)<img src="data:image/png;base64,{{ $data['signature_base64'] }}" style="max-height:16px;">@else&nbsp;@endif</span>/<span class="signature-line" style="width:100px;">&nbsp;</span></p>

    ...
    <p class="initial-line">Initial <span style="width:100px;">@if($data['signature_base64'] ?? null)<img src="data:image/png;base64,{{ $data['signature_base64'] }}" style="max-height:16px;">@else&nbsp;@endif</span>/<span style="width:100px;">&nbsp;</span></p>

...
@section('title', 'Contracts Microsoft 365 Mail')
    ...
    <div class="ld-page">
        <div class="ld-top">
            <div class="ld-top-main">
                ...
                <p class="ld-subtitle">Connect a Microsoft 365 mailbox to send contract signing emails from Contracts &amp; E-Sign.</p>
            </div>
        </div>

        @if(session('status') === 'outlook-mail-connected')
            <div class="ld-flash success" role="alert">Microsoft 365 mailbox connected. You can now send contract emails from this account.</div>
        @endif
        @if(session('error'))
            ...
            <div class="ld-settings-card">
                <div class="ld-settings-card-header">
                    ...
                    <div class="ld-settings-heading">
                        ...
                        <p>Sign in with the Microsoft 365 account that should appear as the sender when you send a contract for signature. If not connected, outbound email falls back to Gmail from <a href="{{ route('integrations') }}">Integrations</a>.</p>
                    </div>
                </div>
                ...
                @else
                    <div class="ld-form-actions" style="border-top: none; padding-top: 0; margin-top: 0;">
                        <a href="{{ route('inbox.connect.outlook', ['intent' => 'contract']) }}" class="btn btn-primary btn-sm" id="m365-sign-in-btn">
            ...
            <aside class="ld-settings-aside">
                ...
                <ol class="ld-steps">
                    ...
                    <li>
                        ...
                        <span>Send a contract for signature — emails go out from this account.</span>
                    </li>
                </ol>
            </aside>
        </div>
...
<script>
    (function () {
        ...
        const apiUrl = @json(route('api.contracts.microsoft-365-mail.get'));
        ...
        disconnectBtn?.addEventListener('click', async function () {
            if (!confirm('Disconnect Microsoft 365? Contract emails will fall back to Gmail if configured.')) {
                return;
            }

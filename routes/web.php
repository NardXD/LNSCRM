...
Route::middleware(['auth', 'company.active'])->group(function () {
    ...
    Route::prefix('api/whatsapp')->middleware('permission:view_whatsapp')->group(function () {
        ...
        Route::patch('/conversations/{conversation}/read', [WhatsAppController::class, 'updateRead'])->name('api.whatsapp.conversations.read');
        Route::post('/conversations/{conversation}/labels', [WhatsAppController::class, 'attachLabel'])->name('api.whatsapp.conversations.labels.attach');
    ...
    Route::prefix('api/facebook')->middleware('permission:view_facebook')->group(function () {
        ...
        Route::post('/conversations/{conversation}/labels', [FacebookController::class, 'attachLabel'])->name('api.facebook.conversations.labels.attach');
    ...
    Route::prefix('api/inbox')->middleware('permission:view_inbox')->group(function () {
        ...
        Route::delete('/conversations/{conversation}/labels/{leadLabel}', [InboxController::class, 'detachConversationLabel'])->name('api.inbox.conversations.labels.detach');
        ...
        Route::post('/compose/share-draft', [InboxController::class, 'shareComposeDraft'])->name('api.inbox.compose.share-draft');
